{-
Copied from:
https://raw.githubusercontent.com/AlexeyPirogov/PricingFinancialContractsWithHaskell/master/src/Contract/Contract.hs
-}
...
data Currency = USD | JPY | GBP | EUR | ZAR | KYD | CHF  deriving (Eq, Show)
